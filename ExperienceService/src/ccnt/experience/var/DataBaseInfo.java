...
public final class DataBaseInfo {
	...
	public static final String DEVICE_TABLE_FORM = "(id,xSize,ySize,storage,cpu_name,maxCpuFreq,minCpuFreq,model,sys_version,out_storage)";// 设备表属性
	public static final String TOUCH_TABLE_FORM = "(ID,trace_detail,current_app,current_activity,device_Id,current_package)";// 数据表属性
